          ...
          {[
            ...
            <div className="space-y-1" key={item.tier}>
              ...
              <div className="relative">
                <span className="absolute start-3 top-1/2 -translate-y-1/2 text-xs text-zinc-500">
                  {item.plan?.currency ?? ""}
                </span>
                <input
                  type="number"
                  ...
                  className="w-full rounded-lg border border-zinc-700 bg-zinc-800 py-2 pe-3 ps-12 text-sm text-zinc-100 focus:border-green-500 focus:outline-none disabled:opacity-50"
                />
              </div>
            </div>
          ))}
