    ...
    <Modal open={open} onClose={onClose} title={`Upgrade to ${plan.tier}`}>
      <div className="space-y-4">
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          You&apos;re about to upgrade to the <strong className="capitalize">{plan.tier}</strong> plan at ${plan.priceMonthly}/mo.
        </p>
        ...
        <p className="text-xs text-zinc-400">Payment will be processed in Phase 2 via a real payment gateway.</p>
